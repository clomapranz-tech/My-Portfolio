<div class="container-fluid px-2">
  ...
  <nav class="navbar navbar-expand-lg">
    ...
    <a href="index.php" style="width: 17%; height: 5rem;">
      <img src="assets/images/XULOGO.png" alt="Logo" style="width: 90%;">
    </a>

    <!-- Search Bar -->
    <form class="flex justify-center" style="width: 60rem;" action="index_search.php" method="GET"> <!-- Update action to index.php -->
